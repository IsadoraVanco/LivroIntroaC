...
3) Hoje nosso herói come fantasmas. Faça ele ter esse poder só se comer uma
    outra pílula. Assim que ele comê-la, ele terá esse poder de comer fantasmas por 20 turnos.
...
6) Melhore a função move(). É possível fazer com que o switch não fique repetindo m.matriz[][] várias vezes.
*/
